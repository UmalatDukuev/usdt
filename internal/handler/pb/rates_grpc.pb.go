...
func (c *rateServiceClient) GetRates(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rates.RateService/GetRates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rateServiceClient) HealthCheck(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HealthStatus, error) {
	out := new(HealthStatus)
	err := c.cc.Invoke(ctx, "/rates.RateService/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRateServiceServer) HealthCheck(context.Context, *Empty) (*HealthStatus, error) {
...
func _RateService_GetRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rates.RateService/GetRates",
	}
...
func _RateService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rates.RateService/HealthCheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
